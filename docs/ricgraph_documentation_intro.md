...
Feel free to browse through the full documentation:

* Choose something from the documentation tree in the yellow sidebar.
* Or, if you use a small screen, click on the icon in the top left in the 
  yellow bar above this text.
* Use the search box.
* Every webpage has links that allow you to go to other sections
  or webpages.
