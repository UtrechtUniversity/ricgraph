...
## Get and use Ricgraph

To learn about how to get and how to use Ricgraph, read
[Get and use 
Ricgraph](https://www.ricgraph.eu/get-and-use-ricgraph.html).
This explains how to use Ricgraph without installing it yourself,
and how to install it yourself.
It also explains how to browse Ricgraph with 
[Ricgraph Explorer](https://docs.ricgraph.eu/docs/ricgraph_explorer.html),
the user interface for Ricgraph.
...
Read more about
[Contact details for Ricgraph](https://www.ricgraph.eu/contact.html).
