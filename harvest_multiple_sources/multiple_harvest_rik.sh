...
#echo "If an error message appears, you cannot use 'sudo' without a"
#echo "password, and then this script will break. Type <cntr>-C to quit."
echo ""
...
explorer_data_collect_dir=$HOME/explorer_data_collect-$(date +%y%m%d-%H%M)
...
./multiple_harvest_organization.sh --organization VU --empty_ricgraph no
