...
# This script harvests the sources for the Open Ricgraph demo server.
# It also dumps the graph database and modifies organization names.
#
# You can run this script as follows:
# - In directory .../ricgraph:
#   make bash_script=harvest_multiple_sources/multiple_harvest_open_ricgraph_demo_server.sh run_bash_script
...
echo "This script harvests the sources for the Open Ricgraph demo server."
...
./multiple_harvest_organization.sh --organization DUT --empty_ricgraph yes --year_first 2022 --year_last 2025
exit_on_error $?
